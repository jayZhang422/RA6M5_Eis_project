...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen, lv_color_hex(0xa4a4a4), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_imgbtn_2
    ui->screen_imgbtn_2 = lv_imagebutton_create(ui->screen);
    lv_obj_set_pos(ui->screen_imgbtn_2, -2, 260);
    lv_obj_set_size(ui->screen_imgbtn_2, 86, 59);
    lv_obj_add_flag(ui->screen_imgbtn_2, LV_OBJ_FLAG_CHECKABLE);
    lv_imagebutton_set_src(ui->screen_imgbtn_2, LV_IMAGEBUTTON_STATE_RELEASED, &_home_RGB565A8_86x59, NULL, NULL);
    ...
    lv_obj_set_pos(ui->screen_imgbtn_1, 396, 270);
    lv_obj_set_size(ui->screen_imgbtn_1, 81, 53);
    lv_obj_add_flag(ui->screen_imgbtn_1, LV_OBJ_FLAG_CHECKABLE);
    lv_imagebutton_set_src(ui->screen_imgbtn_1, LV_IMAGEBUTTON_STATE_RELEASED, &_33333_RGB565A8_81x53, NULL, NULL);
    ...
    lv_obj_set_pos(ui->screen_label_1, 185, 270);
    lv_obj_set_size(ui->screen_label_1, 100, 32);
    lv_label_set_text(ui->screen_label_1, "MENU");
    ...
    //Write codes screen_cont
    ui->screen_cont = lv_obj_create(ui->screen);
    lv_obj_set_pos(ui->screen_cont, 0, 0);
    lv_obj_set_size(ui->screen_cont, 480, 255);
    lv_obj_set_scrollbar_mode(ui->screen_cont, LV_SCROLLBAR_MODE_OFF);

    //Write style for screen_cont, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_cont, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_cont, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_cont, lv_color_hex(0xa4a4a4), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_cont, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_cont, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_cont, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_cont, lv_color_hex(0xa4a4a4), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_cont, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_cont, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_cont, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_cont, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_cont, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_cont, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
