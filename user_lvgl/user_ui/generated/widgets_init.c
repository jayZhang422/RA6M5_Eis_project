...
{
    digital_clock_count(&home_digital_clock_1_hour_value, &home_digital_clock_1_min_value, &home_digital_clock_1_sec_value, home_digital_clock_1_meridiem);
    if (lv_obj_is_valid(guider_ui.home_digital_clock_1))
    {
        lv_label_set_text_fmt(guider_ui.home_digital_clock_1, "%d:%02d:%02d %s", home_digital_clock_1_hour_value, home_digital_clock_1_min_value, home_digital_clock_1_sec_value, home_digital_clock_1_meridiem);
    }
}
...
void home_datetext_1_calendar_event_handler(lv_event_t *e)
{
    ...
    if (code == LV_EVENT_VALUE_CHANGED) {
        ...
        lv_obj_delete(home_datetext_1_calendar);
