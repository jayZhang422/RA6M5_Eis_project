...
gpt_instance_ctrl_t g_timer_lvgl_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer_lvgl_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t g_timer_lvgl_extend =
{
...
#if 0
    .p_pwm_cfg             = &g_timer_lvgl_pwm_extend,
#else
    .p_pwm_cfg             = NULL,
#endif
#if 0
...
const timer_cfg_t g_timer_lvgl_cfg =
{
...
const timer_instance_t g_timer_lvgl =
{
    .p_ctrl        = &g_timer_lvgl_ctrl,
    .p_cfg         = &g_timer_lvgl_cfg,
