/* generated vector source file - do not edit */
        ...
        BSP_DONT_REMOVE const fsp_vector_t g_vector_table[BSP_ICU_VECTOR_NUM_ENTRIES] BSP_PLACE_IN_SECTION(BSP_SECTION_APPLICATION_VECTORS) =
        {
            ...
            [11] = gpt_counter_overflow_isr, /* GPT6 COUNTER OVERFLOW (Overflow) */
            ...
            [15] = dmac_int_isr, /* DMAC1 INT (DMAC1 transfer end) */
            [16] = dmac_int_isr, /* DMAC2 INT (DMAC2 transfer end) */
            [17] = spi_rxi_isr, /* SPI1 RXI (Receive buffer full) */
            [18] = spi_txi_isr, /* SPI1 TXI (Transmit buffer empty) */
            [19] = spi_tei_isr, /* SPI1 TEI (Transmission complete event) */
            [20] = spi_eri_isr, /* SPI1 ERI (Error) */
        ...
        const bsp_interrupt_event_t g_interrupt_event_link_select[BSP_ICU_VECTOR_NUM_ENTRIES] =
        {
            ...
            [11] = BSP_PRV_VECT_ENUM(EVENT_GPT6_COUNTER_OVERFLOW,GROUP3), /* GPT6 COUNTER OVERFLOW (Overflow) */
            [12] = BSP_PRV_VECT_ENUM(EVENT_RTC_ALARM,GROUP4), /* RTC ALARM (Alarm interrupt) */
            ...
            [15] = BSP_PRV_VECT_ENUM(EVENT_DMAC1_INT,GROUP7), /* DMAC1 INT (DMAC1 transfer end) */
            [16] = BSP_PRV_VECT_ENUM(EVENT_DMAC2_INT,GROUP0), /* DMAC2 INT (DMAC2 transfer end) */
            [17] = BSP_PRV_VECT_ENUM(EVENT_SPI1_RXI,GROUP1), /* SPI1 RXI (Receive buffer full) */
            [18] = BSP_PRV_VECT_ENUM(EVENT_SPI1_TXI,GROUP2), /* SPI1 TXI (Transmit buffer empty) */
            [19] = BSP_PRV_VECT_ENUM(EVENT_SPI1_TEI,GROUP3), /* SPI1 TEI (Transmission complete event) */
            [20] = BSP_PRV_VECT_ENUM(EVENT_SPI1_ERI,GROUP4), /* SPI1 ERI (Error) */
